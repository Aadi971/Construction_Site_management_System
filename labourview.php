...
<header>
        <h1>Labour Attendance Sheet</h1>
        <h3>Labour Attendance Month: <u><?php echo date("F"); ?></u></h3>
        <?php
...
<div style="text-align: right;">
  <h3>Mark Attendance : <a href="labourtodayatt.php"><i class="fa fa-edit"></i></a></h3>
</div>
      ...
      for($i=1; $i <= $numberOfStudents+2; $i++){
        if($i == 1){
            ...
            for($j=1; $j<=$totaldaysInMonth; $j++){
              ...
              $fetchingAtt = mysqli_query($conn, "SELECT attendence FROM labour_attendence WHERE l_id = '{$idarray[$counter]}' AND curr_date = '$dateOfAttendance'");
            ...
            ?>
              ...
              <a href="lprofile.php?id=<?php echo $idarray[$counter]; ?>" title='View Profile'><i class="fa fa-play"></i></a>
            <?php
            }
            echo "</td>";
